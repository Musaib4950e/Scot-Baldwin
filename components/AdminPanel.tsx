...
export const AdminPanel: React.FC<AdminPanelProps> = (props) => {
    ...
    const modalSelectClasses = `${modalInputClasses} appearance-none`;
                                    ...
                                    <div className="p-6">
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <textarea id="broadcast" value={broadcastMessage} onChange={e => setBroadcastMessage(e.target.value)} rows={5} className={modalTextareaClasses}></textarea>
                                            </div>
