...
const renderUserBadge = (user: User) => {
    ...
    const colorClasses = { blue: 'text-blue-400', red: 'text-red-400', gold: 'text-amber-400', pink: 'text-pink-400' };
    const badgeColor = user.isAdmin ? 'text-red-400' : colorClasses[user.verification.badgeType || 'blue'] || 'text-blue-400';
